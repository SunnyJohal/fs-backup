...
class TTSearchableSelectControl extends Component {
  constructor(props) {
    super(props);
    this.state = {
      controlId: uuidv4()
  ...
  checkPropTypes = () => {
    PropTypes.checkPropTypes(
      TTSearchableSelectControl.propTypes,
      this.props,
      'prop',
  ...
  render() {
    ...
    return (
      <div className="TTSearchableSelectControl">
        <ControlTitle
          title={label}
...
export default TTSearchableSelectControl;
