...
import TTToggleControl from '../containers/TTToggleControl/TTToggleControl';
 ...
 */
api.TTToggleControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_toggle = api.TTToggleControl;
