...
import TTDropdownPagesControl from '../containers/TTDropdownPagesControl/TTDropdownPagesControl';
 ...
 */
api.TTDropdownPagesControl = api.Control.extend({
  /**
   * Initialize.
   *
  ...
  getSettingParamsFromConfig(id, config) {
    ...
    pages.forEach(page => {
      choices[page.ID.toString()] = page.post_title;
    });
...
wp.customize.controlConstructor.tt_dropdown_pages = api.TTDropdownPagesControl;
