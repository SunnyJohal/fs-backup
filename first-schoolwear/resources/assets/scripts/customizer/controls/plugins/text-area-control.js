...
import TTTextAreaControl from '../containers/TTTextAreaControl/TTTextAreaControl';
const api = wp.customize;

/**
 * Class TTTextAreaControl
 *
 ...
 */
api.TTTextAreaControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_textarea = api.TTTextAreaControl;
