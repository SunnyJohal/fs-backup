...
import TTBackgroundPositionControl from '../containers/TTBackgroundPositionControl/TTBackgroundPositionControl';
const api = wp.customize;

/**
 * Class TTBackgroundPositionControl
 *
 ...
 */
api.TTBackgroundPositionControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_background_position =
  api.TTBackgroundPositionControl;
