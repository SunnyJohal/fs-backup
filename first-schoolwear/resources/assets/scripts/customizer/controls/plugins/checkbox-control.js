...
import TTCheckboxControl from '../containers/TTCheckboxControl/TTCheckboxControl';
 ...
 */
api.TTCheckboxControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_checkbox = api.TTCheckboxControl;
