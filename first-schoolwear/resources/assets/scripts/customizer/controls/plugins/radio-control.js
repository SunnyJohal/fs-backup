...
import TTRadioControl from '../containers/TTRadioControl/TTRadioControl';
const api = wp.customize;

/**
 * Class TTRadioControl
 *
 ...
 */
api.TTRadioControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_radio = api.TTRadioControl;
