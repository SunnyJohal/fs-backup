...
import TTSliderControl from '../containers/TTSliderControl/TTSliderControl';
const api = wp.customize;

/**
 * Class TTSliderControl
 *
 ...
 */
api.TTSliderControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_slider = api.TTSliderControl;
