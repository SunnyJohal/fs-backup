...
import TTSelectControl from '../containers/TTSelectControl/TTSelectControl';
const api = wp.customize;

/**
 * Class TTSelectControl
 *
 ...
 */
api.TTSelectControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_select = api.TTSelectControl;
