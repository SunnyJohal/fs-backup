...
import TTTextControl from '../containers/TTTextControl/TTTextControl';
 ...
 */
api.TTTextControl = api.Control.extend({
  /**
   * Initialize.
   *
...
wp.customize.controlConstructor.tt_text = api.TTTextControl;
